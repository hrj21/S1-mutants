...
- MUTANT+BLV is predicted to be `r abs(round(pairwise_summary[8, ]$b, 3))` OD units higher than to AT-S1+BLV [`r abs(round(pairwise_summary[8, ]$.lower, 3))`, `r abs(round(pairwise_summary[8, ]$.upper, 3))`]

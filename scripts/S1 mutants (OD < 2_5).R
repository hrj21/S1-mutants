...
plot_b <- model_2 %>%
  ...
  annotate(geom = "text", label = "WT", x = -0.152, y = 2.2, size = 3) +
  annotate(geom = "text", label = "N121Q", x = 0.025, y = 2.2, size = 3) +
...
ggsave("plots/Scatter plot with inlay (OD < 2_5).pdf", width = 8, height = 5, device = cairo_pdf)
